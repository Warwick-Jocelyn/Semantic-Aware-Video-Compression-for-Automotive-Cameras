...
#         img2 = trans(img)
#         cv2.imwrite(filename = output_path +  f1[i],img = img2)
#         print("Transforming the %s th image color ..." %i)
...
# Recolor_for_results("/home/wang3_y@WMGDS.WMG.WARWICK.AC.UK/code/deeplabv2/dataset/KITTI_STEP/panoptic_maps/train/0000/", 
# "/home/wang3_y@WMGDS.WMG.WARWICK.AC.UK/code/deeplabv2/dataset/KITTI_STEP/binary-mask-gt/")
# print("..............Recolor done!.............")

in_path = "/home/wang3_y@WMGDS.WMG.WARWICK.AC.UK/code/deeplabv2/dataset/KITTI_STEP/binary-mask-gt/"
out_path = "/home/wang3_y@WMGDS.WMG.WARWICK.AC.UK/Desktop/SA-Compression/1-mask-generation/gt/"
binary_mask_generation(in_path,out_path)
